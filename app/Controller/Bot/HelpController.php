    ...
    public static function guide()
    {
        ...
        $request->setText(function($text) {
            return $text->addText('🤖WELCOME🤖')->newLine(3)
                ->addText('Selamat datang di pusat bantuan OPNIMUS (Operational Network Infra Monitoring')
                ->addText(' & Surveillance System) versi 2.0 . OPNIMUS adalah sebuah sistem monitoring kondisi')
                ->addText(' kesehatan network element secara realtime dan sistem early warning terhadap potensi')
                ->addText(' gangguan karena permasalahan fisik (catuan, suhu, arus listrik).')->newLine(3)
                ...
                ->addInlineCode('    Format Syntax /alert ON untuk menyalakan /alert OFF untuk mematikan')->newLine()
                ...
                ->addText('    Alarm Perihal PLN OFF dan GENSET ON.')
                ->endInlineCode()->newLine()
                ...
                ->addText('15. /resetuser - Reset User dan keluar dari OPNIMUS')->newLine(2)
